...
with a parser for Scheme expressions. (along with 以及)

In addition to (除了) the types defined in this file, some data types in Scheme are
represented by their corresponding(相应的) type in Python:
    number:       int or float
    symbol:       string
    boolean:      bool
    unspecified:  None
